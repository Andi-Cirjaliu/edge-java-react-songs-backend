...
public class StaticContentIT {
    ...
    private String url = "http://localhost:" + port+"/java_sample";
    ...
    public void testEndpoint() throws Exception {
        ...
        // assertTrue("Incorrect contents, expected to see 'IBM Cloud Starter', found: " + content, content.contains("Java sample application"));
    }
}
